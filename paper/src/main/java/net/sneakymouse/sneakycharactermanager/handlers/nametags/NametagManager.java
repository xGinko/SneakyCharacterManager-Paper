...
public class NametagManager {
    ...
    public void nicknamePlayer(Player player, String nickname) {
        if (player.isDead() || player.getGameMode() == GameMode.SPECTATOR || (SneakyCharacterManagerPaper.isPapiActive() && !PlaceholderAPI.setPlaceholders(player, "%cmi_user_vanished_symbol%").isEmpty())) return;
