...
import net.sneakymouse.sneakycharactermanager.commands.CommandNick;
import net.sneakymouse.sneakycharactermanager.commands.CommandSkin;
import net.sneakymouse.sneakycharactermanager.consolecommands.ConsoleCommandCharDisable;
import net.sneakymouse.sneakycharactermanager.consolecommands.ConsoleCommandCharEnable;
